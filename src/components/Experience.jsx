  ...
  return (
    ...
    <div>
        {EXPERIENCES.map((experience, index)=> {
            ...
            const truncatedDescription = experience.description.split("\n").slice(0, 1).join("\n");
            ...
            {experience.year}
                ...
                <h6 className="mb-2 font-semibold">{experience.role} - 
                    ...
                    <p className='mb-4 text-neutral-400'>{isExpanded ? experience.description : truncatedDescription}  
                    {!isExpanded && experience.description.split("\n").length > 4 && (
                    <button
